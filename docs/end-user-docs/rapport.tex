...
De broncode van de rekentool bevindt zich in de \texttt{dfasttf} folder. De analyse kan uitgevoerd worden middels het commando \texttt{python -m src}. Hierbij moeten twee additionele argumenten worden opgegeven:
\begin{itemize}
